        ...
        <div class="panel panel-primary setup-content" id="step-2">
       	...
       	<div class="panel-body">
				<div class="form-group row">
				  ...
				  <div class="col-md-4"><label for="ongoing">
				...
				<div class="form-group row">
				  ...
				  <div class="col-md-2"><label for="endno">
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            ...
            <div class="panel-body">
				...
				<div class="form-group row">
					  ...
					  <div class="col-md-2">
					  <input id="age2" name="age2" value="55" type="text" placeholder="" class="form-control input-md">
					  </div>
				</div>
